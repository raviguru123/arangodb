...
struct RocksDBMapSetup {
  RocksDBMapSetup() { BOOST_TEST_MESSAGE("setup RocksDBMap"); }

  ~RocksDBMapSetup() { BOOST_TEST_MESSAGE("tear-down RocksDBMap"); }
};
...
BOOST_FIXTURE_TEST_SUITE(RocksDBMapTest, RocksDBMapSetup)
