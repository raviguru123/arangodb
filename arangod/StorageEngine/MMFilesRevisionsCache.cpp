...
void MMFilesRevisionsCache::insert(TRI_voc_rid_t revisionId,
...
void MMFilesRevisionsCache::update(TRI_voc_rid_t revisionId,
                                   uint8_t const* dataptr, TRI_voc_fid_t fid,
                                   bool isInWal) {
  TRI_ASSERT(revisionId != 0);
  TRI_ASSERT(dataptr != nullptr);
...
bool MMFilesRevisionsCache::updateConditional(
  ...
  TRI_df_marker_t const* markerPtr = reinterpret_cast<TRI_df_marker_t const*>(
      vpack -
